...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Sign up with metadata - role defaults to 'user', admin set via app_metadata manually
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
            <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 text-gray-700 px-4 py-3 rounded-lg hover:bg-gray-50 transition font-medium mb-6 disabled:opacity-50"
                >
